...
_MODEL_NAME = "MayZhou/e5-small-lora-ai-generated-detector"
_model = None
_tokenizer = None
...
def _get_ai_index(model) -> int:
    ...
    for idx, label in id2label.items():
        ...
        if any(
            kw in label_lower for kw in ("ai", "fake", "generated", "machine", "gpt")
        ):
            return int(idx)
    return 1
...
class ClassifierE5Engine(BaseEngine):
    @property
    def name(self) -> str:
        return "E5-Small"
    ...
    def description(self) -> str:
        return "Ultra-lightweight E5 LoRA detector — 33M params, #2 on RAID benchmark"
    ...
    @property
    def url(self) -> str:
        return "https://huggingface.co/MayZhou/e5-small-lora-ai-generated-detector"
    ...
    def analyze(self, text: str) -> EngineResult:
        ...
        return EngineResult(
            ...
            details=f"AI probability: {score:.1%} (E5-small LoRA, RAID #2)",
            description=self.description,
        )
